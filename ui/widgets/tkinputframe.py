from tkinter import Frame, Entry, StringVar, RAISED
...
class TKInputFrame:
    ...
    def create_frame(self, label_text):
        ...
        # 타이머 레이블 생성
        self.timer_label = TKTimer(master=self.frame, text="00:00", font=self.font, bg="#AAAAAA", anchor="e")
        self.timer_label.pack(side="right", padx=5, pady=5)
        self.timer_label.start()  # 타이머 시작
    ...
    def disable_input(self):
        self.input_entry.config(state="disabled", disabledbackground="#666666")
